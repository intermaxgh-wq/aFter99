  ...
  // ---------- Product data ----------
  var PRODUCTS = [
    {name:'21:00 Hoodie', meta:'Heavyweight fleece', price:420, initials:'21'},
    {name:'Curfew Sweats', meta:'Brushed fleece jogger', price:380, initials:'CS'},
    {name:'Midnight Vex', meta:'Heavy cotton', price:160, initials:'MV'},
    {name:'Pink Riot', meta:'Pretty Danger', price:650, initials:'PR'},
    {name:'Afterglow Beanie', meta:'Ribbed knit', price:110, initials:'AG'}
  ];
  ...
  var LE_STATE = { stock: 99, blurred: true };
